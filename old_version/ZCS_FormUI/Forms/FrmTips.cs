    ...
    public partial class FrmTips : FrmBase
    {
            ...
            else
            {
                ...
                switch (state)
                {
                    case TipsState.Default:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.alarm;
                        break;
                    case TipsState.Success:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.success;
                        break;
                    case TipsState.Info:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.alarm;
                        break;
                    case TipsState.Warning:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.warning;
                        break;
                    case TipsState.Error:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.error;
                        break;
                    default:
                        frmTips.pctStat.Image = ZCS_FormUI.Properties.Resources.alarm;
                        break;
        ...
        public static void ReshowTips()
        {
            lock (FrmTips.m_lstTips)
            {
                ...
                FrmTips firstTip = FrmTips.m_lstTips.FirstOrDefault();
