...
namespace ZCS_FormUI.Controls
{
    ...
    /// Implements the <see cref="ZCS_FormUI.Controls.IDataGridViewRow" />
    /// </summary>
    /// <seealso cref="System.Windows.Forms.UserControl" />
    /// <seealso cref="ZCS_FormUI.Controls.IDataGridViewRow" />
    [ToolboxItem(false)]
        ...
        public void BindingCellData()
        {
            if (DataSource != null)
            {
                for (int i = 0; i < Columns.Count; i++)
                {
                    ...
                    Control[] cs = this.panCells.Controls.Find("lbl_" + com.DataField, false);
                    if (cs != null && cs.Length > 0)
                    {
                        ...
                        {
                            System.Reflection.PropertyInfo pro = DataSource.GetType().GetProperty(com.DataField);

                            if (pro != null)
                            {
                                object value = pro.GetValue(DataSource, null);
                                if (com.Format != null)
                                {
                                    if (value == null)
                                    {
            ...
            try
            {
                ...
                if (Columns != null && intColumnsCount > 0)
                {
                    ...
                    for (int i = 0; i < intColumnsCount; i++)
                    {
                        ...
                        {
                            DataGridViewColumnEntity item = Columns[i - (IsShowCheckBox ? 1 : 0)];
