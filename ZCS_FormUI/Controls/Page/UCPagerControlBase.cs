...
namespace ZCS_FormUI.Controls
{
    ...
    /// Implements the <see cref="ZCS_FormUI.Controls.IPageControl" />
    /// </summary>
    /// <seealso cref="System.Windows.Forms.UserControl" />
    /// <seealso cref="ZCS_FormUI.Controls.IPageControl" />
    [ToolboxItem(false)]
    public class UCPagerControlBase : UserControl, IPageControl
    {
        ...
        private PageModel m_pm = PageModel.PageCount;
        ...
        {
            if (PageModel == ZCS_FormUI.Controls.PageModel.Soure)
            {
                if (DataSource == null)
                {
                    ShowBtn(false, false);
